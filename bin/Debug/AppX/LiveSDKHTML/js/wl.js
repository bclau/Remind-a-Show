...
WL.init = function (properties) {
    ...
    /// The redirect_uri value must match the redirect domain of the registered app.
            ...
            function (delegation_result) {
                ...
                if (accessToken && accessToken !== "") {
                    if (wl_app._domain) {
                        ...
                        authMethod(uiOption, wl_app._domain, "JWT").then(
...
wl_app[API_X_HTTP_LIVE_LIBRARY] = "Windows/HTML8_" + trimVersionBuildNumber("5.5.3502.1014");
